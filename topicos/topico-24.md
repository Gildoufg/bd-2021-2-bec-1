## [Tópico T24] - Modelo Entidade Relacionamento (MER) - Generalização/Especialização
...
Criar uma _issue_ no projeto https://github.com/plinioleitao/bd-2021-2-bec, com o título "Tópico 24", para responder: 

Para responder as questões abaixo:
- Some as alternativas que se aplicam ao enunciado da questão.
- Acrescente ao somátório a quantidade de letras do seu primeiro nome.
- Por exemplo, se a soma for 03 e o seu primeiro nome for 'Ana', então a resposta para a questão é 06.

**Questão 01)** Some as alternativas CORRETAS:<br>
(01) Há duas hierarquias do tipo generalização/especialização?<br>
(02) É possível inserir um funcionário cujo cargo não é _secretária_, _técnico_ e _engenheiro_ (por exemplo, _médico_)?<br>

**Questão 02)** Some as alternativas INCORRETAS:<br>
(01) Todo funcionário é secretária, técnico ou engenheiro?<br>
(02) Um funcionário horista pode ser gerente de projeto?<br>

**Questão 03)** Some as alternativas CORRETAS:<br>
(01) Uma secretária pode ser gerente de projeto de projeto?<br>
(02) Um engenheiro pode ser horista?<br>

**Questão 04)** Some as alternativas INCORRETAS:<br>
(01) TECNICO e ENGENHEIRO representam dois subconjuntos disjuntos?<br>
(02) ENGENHEIRO e GERENTE representam dois subconjuntos disjuntos?<br>
...
1. _Issue_ criada no projeto https://github.com/plinioleitao/bd-2021-2-bec, cujo título é "Tópico 24", para indicar suas reflexões iniciais sobre *generalização/especialização no Modelo Entidade Relacionamento (MER)*.
