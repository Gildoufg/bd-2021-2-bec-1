## [Tópico T17] - SQL - DML (Data Manipulation Language): Funções Agregadas, Agrupamento de dados, Ordenação de Dados
...
## Atividade (data limite: **27/02/2022 23h59min59s**)

Criar uma _issue_ no projeto https://github.com/plinioleitao/bd-2021-2-bec, com o título "Tópico 17", para responder: 

1. Seja o comando SQL:<br>&nbsp;&nbsp;SELECT Salario<br>&nbsp;&nbsp;FROM FUNCIONARIO<br>&nbsp;&nbsp;WHERE Salario >= 13000 + ( SELECT MIN(Salario) FROM FUNCIONARIO )<br>Considere que na relação FUNCIONARIO:<br>■ há 4 (quatro) _tuplas_;<br>■ os salários 10000, 20000, 30000, 25500.<br>Qual a soma dos salários que são retornados pela consulta?
